    ...
    public class Target_Changer : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            for (int i = 0; i < vcam_len; i++)
            {
                ...
                Debug.Log($"vcamobj{i}:{vcam_obj[i].transform.position}");
            }
